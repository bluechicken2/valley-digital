...
SERVICE_KEY = os.environ.get('SUPABASE_SERVICE_KEY', os.environ.get('SERVICE_ROLE_SUPABASE', os.environ.get('SUPABASE_ANON_KEY', 'sb_publishable_ydepQXbHFjFA-_TIwOYNHg_SwN0m5PL')))
